...
if __name__ == '__main__':
    ...
    extensions = ['.js']  # Danh sách các phần mở rộng tệp
    filenames = ['index.html']  # Danh sách các tên tệp cụ thể
    exclude_dirs = ['node_modules', 'data', '.tools', '.vscode', '.git', 'lib']  # Thư mục cần bỏ qua
    exclude_files = ['.gitignore']  # Tệp cần bỏ qua
